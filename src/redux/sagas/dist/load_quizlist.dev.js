...
exports.watchLoadQuizList = watchLoadQuizList;

var _axios = _interopRequireDefault(require("axios"));

var _effects = require("redux-saga/effects");

var _load_quiz_list = require("../actions/load_quiz_list");
...
regeneratorRuntime.mark(workerLoadData),
    _marked2 =
/*#__PURE__*/
regeneratorRuntime.mark(watchLoadQuizList);

//import { LOAD_QUIZZES, showQuizzes } from "../actions/show_quizzes";
var fetchData = function fetchData() {
  return _axios["default"].get("http://134.249.181.40:7777/api/");
};
...
function watchLoadQuizList() {
  return regeneratorRuntime.wrap(function watchLoadQuizList$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return (0, _effects.takeEvery)(_load_quiz_list.LOAD_QUIZ_LIST, workerLoadData);
