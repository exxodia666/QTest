		...
		Array.from(inputs).forEach((el) => {
			...
			switch (armel[0]) {
				...
				case 'question':
					...
					break;
				case 'choice':
					if (data.questions[parseInt(armel[2])]['choices'][parseInt(armel[3])]) {
						data.questions[parseInt(armel[2])]['choices'][parseInt(armel[3])][armel[1]] =
				...
				e.question_id === el
					? {
							...
							choises: [
								...e.choises,
								{
									choise_id: prevArray[el].choises[prevArray[el].choises.length - 1].choise_id + 1,
									isCorect: false,
								},
							],
					  }
			...
			<div className="content_container">
				<div className="content__">
					...
					<div className="test-name_container">
						<input type="text" name="quiz-quiz_name" className="text-input" placeholder="Название теста" />
					</div>
					<div className="checkbox">
						<input id="is_public" name="quiz-is_public" type="checkbox" className="inp" />
					...
					<div className="add-question-button_container">
						<div onClick={addNewQuestion} className="add-question-button add-button button">
			...
			<div id="quiz_id" className="content__auth">
				<div className="autorization_container">
					...
					<div className="button_container">
						<input onClick={copy} type="button" className="button_vote button" value="Копировать" />
					</div>
				</div>
			</div>
		);
